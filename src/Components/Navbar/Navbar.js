...
const Navbar = () => {
  ...
  const handleLogout = async () => {
    try {
      ...
      // PERBAIKAN: Menghapus 'const response =' karena tidak digunakan
      ...
      // Selalu hapus token dan user, lalu redirect ke halaman login
      // Ini memastikan pengguna logout di frontend bahkan jika API gagal
